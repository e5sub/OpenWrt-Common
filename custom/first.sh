...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/e5sub/OpenWrt-Common build/common
...
git clone -b main --depth 1 https://github.com/e5sub/OpenWrt_Build_x64_all shangyou
...
if [[ "${GIT_REPOSITORY}" =~ (28677160/build-actions|e5sub/OpenWrt_Build_x64_all) ]]; then
  rm -rf backups
...
curl -fsSL https://raw.githubusercontent.com/e5sub/OpenWrt-Common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/e5sub/OpenWrt-Common/main/common.sh -O common.sh
fi
